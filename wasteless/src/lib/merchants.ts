...
const MERCHANT_ALIASES: Record<string, string[]> = {
  ...
  "5M Migros": ["5m migros", "5m migros silivri"],
  "Tiki Beach": ["tiki beach", "tiki beach bodrum"],
  "Altınkılıçlar Kahve": ["altinkiliclar kahve", "altınkılıçlar kahve"],
  "Çehre Gıda": ["çehre gida", "çehre gıda"],
  "Şengül Hediyelik": ["şengül hediyelik", "sengul hediyelik"],
  "Özyıldız Petrol": ["özyıldız petrol", "ozyildiz petrol", "özyildiz petrol"],
